...
TABLE_COLUMNS = {
    "users": ["id", "role", "full_name", "email", "password_hash", "phone", "address", "aadhaar_path", "pan_path", "kyc_status", "kyc_rejection_reason", "kyc_reviewed_at", "kyc_reviewed_by", "parent_id", "md_id", "commission_percent", "base_commission", "markup_commission", "total_commission", "admin_pct", "md_pct", "dist_pct", "commission_type", "created_by_role", "created_by_id", "frozen", "is_deleted", "created_at", "created_by", "password_changed_at", "firm_name", "firm_address", "first_login", "welcome_shown", "aadhaar_back_path", "pan_back_path", "selfie_path", "cheque_path", "firm_front_path", "t1_commission_percent", "t1_admin_pct", "t1_md_pct", "t1_dist_pct", "mpin_hash", "tpin_hash", "permissions"],
    ...
    "settings": ["id", "default_percent", "updated_at", "min_recharge_limit", "max_recharge_limit", "qr_enabled", "recharge_enabled", "withdrawal_enabled", "bill_pay_enabled", "t1_qr_enabled", "live_bill_enabled", "live_bill_api_charge", "logo_path", "favicon_path", "logo_collapsed_path", "watermark_path", "t1_recharge_enabled", "live_bill_max_limit"],
