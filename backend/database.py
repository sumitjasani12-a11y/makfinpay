...
TABLE_COLUMNS = {
    ...
    "settings": ["id", "default_percent", "updated_at", "min_recharge_limit", "max_recharge_limit", "qr_enabled", "recharge_enabled", "withdrawal_enabled", "bill_pay_enabled", "t1_qr_enabled", "live_bill_enabled", "live_bill_api_charge", "logo_path", "favicon_path", "logo_collapsed_path", "watermark_path"],
