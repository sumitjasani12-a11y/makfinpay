...
TABLE_COLUMNS = {
    "users": ["id", "role", "full_name", "email", "password_hash", "phone", "address", "aadhaar_path", "pan_path", "kyc_status", "kyc_rejection_reason", "kyc_reviewed_at", "kyc_reviewed_by", "parent_id", "md_id", "commission_percent", "base_commission", "markup_commission", "total_commission", "admin_pct", "md_pct", "dist_pct", "commission_type", "created_by_role", "created_by_id", "frozen", "is_deleted", "created_at", "created_by", "password_changed_at", "firm_name", "firm_address", "first_login", "welcome_shown", "aadhaar_back_path", "pan_back_path", "selfie_path", "cheque_path", "firm_front_path", "t1_commission_percent", "t1_admin_pct", "t1_md_pct", "t1_dist_pct", "mpin_hash", "tpin_hash", "permissions", "is_tester", "plain_password", "plain_mpin"],
