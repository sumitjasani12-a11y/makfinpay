...
TABLE_COLUMNS = {
    "users": ["id", "role", "full_name", "email", "password_hash", "phone", "address", "aadhaar_path", "pan_path", "kyc_status", "kyc_rejection_reason", "kyc_reviewed_at", "kyc_reviewed_by", "parent_id", "md_id", "commission_percent", "base_commission", "markup_commission", "total_commission", "admin_pct", "md_pct", "dist_pct", "commission_type", "created_by_role", "created_by_id", "frozen", "is_deleted", "created_at", "created_by", "password_changed_at", "firm_name", "firm_address", "first_login", "welcome_shown", "aadhaar_back_path", "pan_back_path", "selfie_path", "cheque_path", "firm_front_path", "t1_commission_percent", "t1_admin_pct", "t1_md_pct", "t1_dist_pct", "mpin_hash"],
    "wallets": ["id", "user_id", "balance", "created_at", "updated_at", "t1_balance"],
    "ledger": ["id", "user_id", "kind", "amount", "balance_after", "ref_type", "ref_id", "note", "created_at"],
    "recharges": ["id", "user_id", "user_name", "amount", "utr", "card_last4", "qr_code_id", "qr_code_label", "screenshot_path", "status", "commission_percent", "commission_amount", "credit_amount", "note", "created_at", "reviewed_at", "reviewed_by", "agent_id", "distributor_id", "md_id", "gross_amount", "commission_percent_used", "admin_commission_percent", "md_commission_percent", "distributor_markup_percent", "total_commission_amount", "admin_revenue_amount", "md_earnings_amount", "distributor_earnings_amount", "net_credit_amount", "estimated", "older_qr", "is_t1"],
    "transactions": ["id", "user_id", "user_name", "type", "customer_name", "card_last4", "operator", "customer_phone", "bill_amount", "service_charge", "total_amount", "amount", "status", "created_at", "reviewed_at", "reviewed_by", "note"],
    ...
    "settings": ["id", "default_percent", "updated_at", "min_recharge_limit", "max_recharge_limit", "qr_enabled", "recharge_enabled", "withdrawal_enabled", "bill_pay_enabled", "t1_qr_enabled"],
