...
TABLE_COLUMNS = {
    ...
    "recharges": ["id", "user_id", "user_name", "amount", "utr", "card_last4", "qr_code_id", "qr_code_label", "screenshot_path", "status", "commission_percent", "commission_amount", "credit_amount", "note", "created_at", "reviewed_at", "reviewed_by", "agent_id", "distributor_id", "md_id", "gross_amount", "commission_percent_used", "admin_commission_percent", "md_commission_percent", "distributor_markup_percent", "total_commission_amount", "admin_revenue_amount", "md_earnings_amount", "distributor_earnings_amount", "net_credit_amount", "estimated", "older_qr", "is_t1", "settled_t1", "settled_t1_at", "ocr_utr", "ocr_amount", "ocr_qr_name", "ocr_match", "ocr_bypass"],
