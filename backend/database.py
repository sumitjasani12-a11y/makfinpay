...
TABLE_COLUMNS = {
    ...
    "transactions": ["id", "user_id", "user_name", "type", "customer_name", "card_last4", "operator", "customer_phone", "bill_amount", "service_charge", "total_amount", "amount", "status", "created_at", "reviewed_at", "reviewed_by", "note", "operator_txn_id"],
    ...
    "settings": ["id", "default_percent", "updated_at", "min_recharge_limit", "max_recharge_limit", "qr_enabled", "recharge_enabled", "withdrawal_enabled", "bill_pay_enabled", "t1_qr_enabled", "live_bill_enabled"],
