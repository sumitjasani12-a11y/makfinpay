          ...
          <div className="bg-white border border-black/5 rounded-3xl p-6 lg:p-10 shadow-lg shadow-indigo-500/5 grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            ...
            <div className="flex flex-col items-center w-full" data-testid="active-qr-panel">
              ...
              {qr ? (
                <div className="w-full flex flex-col items-center">
                  ...
                  <div className="mt-4 w-full max-w-[280px] flex items-center justify-center gap-2 bg-[#E8F5E9] text-[#00966B] border border-[#C8E6C9] py-2.5 px-4 rounded-xl text-xs font-extrabold uppercase tracking-wide shadow-sm">
            ...
            <div className="space-y-6 w-full">
              ...
              <form onSubmit={submit} className="space-y-4">
                ...
                {shot && !ocrLoading && ocrValidation && !ocrValidation.allMatched && (
                  <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 space-y-3 mb-3">
