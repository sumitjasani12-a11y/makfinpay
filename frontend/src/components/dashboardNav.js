...
export const NAV = {
  admin: [
    ...
    { to: "/admin/headlines", label: "Add Announcement", icon: ScrollText },
    {
      ...
      children: [
        ...
        { to: "/admin/payout-slabs", label: "Payout Slabs", icon: Layers },
        { to: "/admin/banks", label: "Bank Entry", icon: Landmark },
        { to: "/admin/cc-billers", label: "CC Billers", icon: Landmark },
        { to: "/admin/biller-categories", label: "Biller Category", icon: Layers },
  ...
  master_distributor: [
    ...
    { to: "/md/payout", label: "Bank Payout", icon: Landmark },
  ...
  distributor: [
    ...
    { to: "/distributor/payout", label: "Bank Payout", icon: Landmark },
  ...
  agent: [
    ...
    { to: "/agent/payout", label: "Bank Payout", icon: Landmark },
