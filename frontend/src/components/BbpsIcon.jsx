 ...
 * Exact vector artwork from official Adobe Illustrator SVG file.
 */
export default function BbpsIcon({ className = "h-5 w-5", color = "#3469C7", strokeWidth, ...props }) {
  return (
    <svg
